...
def main():
    ...
    model.fit(train_set_x, train_set_y, batch_size=40, epochs=200, verbose=1, validation_data=(valid_set_x, valid_set_y))
...
def modelNet(input_shape=(57, 47, 1), classes=40):
    ...
    x = Dense(2000, activation=None, name='dense1')(x)
    # x = BatchNormalization()(x)
    x = Activation('relu', name='relu_conv3')(x)

    x = Dense(classes, activation=None, name='dense2')(x)
