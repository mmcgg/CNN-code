...
model_final = load_model('C:/Users/Spencer/Documents/GitHub/CNN-code/squeezeNet/model_faceId_test.h5', {'contrastive_loss':contrastive_loss})

filepath = "C:/Users/Spencer/Documents/GitHub/CNN-code/dataset/nnlfw/test/"
ly = []
ln = []
for i in range(500):
    print(i)
