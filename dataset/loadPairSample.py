...
def val_generator(batch_size):
	while 1:
		...
		for _ in range(batch_size):
			if switch:
				X.append(create_couple_rgb("C:/Users/Spencer/Documents/GitHub/CNN-code/dataset/nnlfw/test/").reshape((2,100,100,3)))
				y.append(np.array([0.]))
			else:
				X.append(create_wrong_rgb("C:/Users/Spencer/Documents/GitHub/CNN-code/dataset/nnlfw/test/").reshape((2,100,100,3)))
				y.append(np.array([1.]))
			switch = not switch
		X = np.asarray(X)
		y = np.asarray(y)
...
if __name__ == '__main__':
   	#create_couple_rgb("C:/Users/Spencer/Documents/GitHub/CNN-code/dataset/nnlfw/test/")
    #generator(3)
    create_wrong_rgb("C:/Users/Spencer/Documents/GitHub/CNN-code/dataset/nnkfw/test/")
